...
```{r}
ggplot(df_neigh_3Q.train, aes(x=PRICE-price_est))+geom_histogram(color='red', fill='blue')
```
...
Los residuos sigue una distribución normal y los valores medios de los residuos deben estar centrados en 0.
